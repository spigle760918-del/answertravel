...
type RunRow = { id: string; tenant_id: string; brand_truth_card_id: string; brand_truth_version: number; status: "succeeded" | "failed";
  provider: "deepseek" | "user_approved_snapshot"; model: string; prompt_version: "question-expansion.v1" | "question-expansion.v2" | "question-snapshot.v1"; evidence_id: string; error_code: string | null; requested_at: Date; completed_at: Date };
